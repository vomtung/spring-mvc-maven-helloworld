...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/user/css/style.css" />
    </head>
    <body>
        ...
        <div id="wrap">
            ...
            <div class="header">
                ...
                <div id="menu">
                    <ul>                                                                       
                        <li class="selected"><a href="<%=request.getContextPath()%>/home/index.html">home</a></li>
                        <li><a href="<%=request.getContextPath()%>/home/aboutus.html">about us</a></li>
                        <li><a href="<%=request.getContextPath()%>/home/category.html">flowers</a></li>
                        <li><a href="<%=request.getContextPath()%>/home/specials.html">specials gifts</a></li>
                        <li><a href="<%=request.getContextPath()%>/home/myaccount.html">my accout</a></li>
                        <li><a href="<%=request.getContextPath()%>/home/register.html">register</a></li>
                        <li><a href="<%=request.getContextPath()%>/home/details.html">prices</a></li>
                        <li><a href="<%=request.getContextPath()%>/home/contact.html">contact</a></li>
                    </ul>
                </div>     
            ...
            <div class="center_content">
                <div class="left_content">
                    ...
                    <div class="cart">
                        ...
                        <a href="<%=request.getContextPath()%>/home/cart.html" class="view_cart">view cart</a>
