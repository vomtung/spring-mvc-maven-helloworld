...
<div class="title"><span class="title_icon"><img src="${pageContext.servletContext.contextPath}/resources/user/images/bullet1.gif" alt="" title="" /></span>Product name</div>

<div class="feat_prod_box_details">

    <div class="prod_img"><a href="details.html"><img src="${pageContext.servletContext.contextPath}/resources/user/images/prod1.gif" alt="" title="" border="0" /></a>
        <br /><br />
        <a href="images/big_pic.jpg" rel="lightbox"><img src="${pageContext.servletContext.contextPath}/resources/user/images/zoom.gif" alt="" title="" border="0" /></a>
    </div>
    ...
    <div class="prod_det_box">
        ...
        <div class="box_center">
            ...
            <div class="price"><strong>COLORS:</strong> 
                <span class="colors"><img src="${pageContext.servletContext.contextPath}/resources/user/images/color1.gif" alt="" title="" border="0" /></span>
                <span class="colors"><img src="${pageContext.servletContext.contextPath}/resources/user/images/color2.gif" alt="" title="" border="0" /></span>
                <span class="colors"><img src="${pageContext.servletContext.contextPath}/resources/user/images/color3.gif" alt="" title="" border="0" /></span>                    </div>
            <a href="details.html" class="more"><img src="${pageContext.servletContext.contextPath}/resources/user/images/order_now.gif" alt="" title="" border="0" /></a>
            <div class="clear"></div>
        </div>
